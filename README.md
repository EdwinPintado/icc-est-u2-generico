...
Ademas se utilizaron los metodos propios de estas clases, con el objetivo de corroborar que estas funcionan y que sus metodos pueden usar diferentes datos primitivos, si los implementas correctamente. 


---
![alt text](assets/01-captura-salida-consola.png)
![alt text](assets/02-app-implementacion-codeconsola.png)